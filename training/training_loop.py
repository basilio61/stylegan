...
def training_loop(
    ...
    resume_run_id           = '/content/stylegan/karras2019stylegan-cats-256x256.pkl',     # Run ID or network pkl to resume training from, None = start from scratch.
    resume_snapshot         = None,     # Snapshot index to resume training from, None = autodetect.
    resume_kimg             = 3500,      # Assumed training progress at the beginning. Affects reporting and training schedule.
